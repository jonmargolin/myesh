...
const Article = () => {
    ...
    const customComponents = {
        h1: ({ node, ...props }: any) => <h1 style={{ fontWeight: '500', fontSize: '36px', fontFamily: 'PloniMedium' }}>{props.children}</h1>,
        h4: ({ node, ...props }: any) => <h4 style={{ fontWeight: '500', fontSize: '20px', fontFamily: 'PloniMedium' }}>{props.children}</h4>,
